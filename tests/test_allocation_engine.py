...
def test_allocation_engine_scores_simulates_and_recommends_budget():
    ...
    messages = pd.DataFrame(
        [
            {
                "municipio_id_ibge7": "3550308",
                "ranking_mensagem_cidade": 1,
                "plataforma": "meta_ads",
                "mensagem": "Mais emprego",
            ...
            },
            {
                ...
                "tema": "saude",
                "narrativa": "protecao",
                "publico_alvo": "familias_e_mulheres",
            },
        ]
    )
    recommendations = recommend_allocation(
        scores=scores, budget_simulation=simulation, mart_message=messages, total_budget=50_000
    )
